...
namespace HomeCare.Domain.Aggregates.Payments
{
    internal class PaymentService : IPaymentService
    {
        ...
        private void NotifyPaymentRefund(Payment payment)
        {
            ...
            _notificationFacade.SendAsync(payment.Contract.Client, "Pagamento foi estornado", text);
        }
        ...
        private void NotifyPaymentConfirmed(Payment payment)
        {
            ...
            _notificationFacade.SendAsync(payment.Contract.Supplier, "Pagamento confirmado", text);
        }
